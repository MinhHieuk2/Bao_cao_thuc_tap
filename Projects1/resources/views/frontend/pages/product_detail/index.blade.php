                ...
                <div class="right__content">
                    <div class="info">
                        ...
                        <div class="infomation">
                            <h2 class="infomation__title">Thông tin cơ bản</h2>
                    ...
                    <div class="ads">
                        <a href="#" title="Giam giá" target="_blank"><img alt="Hoan tien" style="width: 100%" src="{{ url('images/banner/banner_01.png') }}"></a>
                    </div>
                </div>
            </div>
        </div>
